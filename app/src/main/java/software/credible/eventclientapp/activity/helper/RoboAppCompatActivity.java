...
/**
 * Since RoboElectric 3 does not provide a RoboAppCompatActivity, we're going to
 * add a hack here to extend RoboFragment activity, while doing everything that
 * AppCompatActivity does in the Android API.
 *
 * See: https://github.com/roboguice/roboguice/issues/311
 */
